...
def main():
    ...
    # Plot results
    label = "Target BER Rate Manager"
    plt.figure(1)
    plt.plot(TIME, selected_mcs_t, marker="x", linewidth=0.2, markersize=7.0, label="MCS index")
    plt.title("MCS for each time value: Target BER Agent", fontsize=18)
    ...
    plt.title("Scenario throughput for the Target BER Agent", fontsize=18)
